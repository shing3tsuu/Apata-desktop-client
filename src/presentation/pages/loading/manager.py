...
class LoadingManager(Container):
    async def synchronize_contacts(self) -> bool:
        ...
        try:
            ...
            server_contacts = await self.state.contact_http_service.get_contacts(self.state.server_user_id)
            ...
            for server_contact in server_contacts:
                ...
                if local_contact:
                    ...
                    self.logger.info(f"Updated contact: {server_contact.username}")
                else:
                    # Add new contact
    ...
    async def sync_message_history(self) -> bool:
        ...
        try:
            ...
            contacts = await self.state.contact_service.get_contacts(self.state.local_user_id)
            # Update keys state
    ...
    async def rotate_keys(self) -> bool:
        try:
            ...
            data = await self.state.auth_http_service.get_public_keys(self.state.server_user_id)
